...
loader = WebBaseLoader(
    web_paths=["https://harkirat.classx.co.in/new-courses/14-complete-web-development-devops-blockchain-cohort"]
)
docs = loader.load()
...
async def retrieve_context(query: str):
    """Search for info related to the educosys genai course"""
    try:
...
async def main():
    ...
    input_message = "give me curriculum of week 1 of this course?"
